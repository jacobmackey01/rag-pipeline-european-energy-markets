...
# The important design choice here is preserving original source text: token
# offsets choose boundaries, then the original string is sliced so numeric
# evidence like 5.25%, 2025-2026, and bidding-zone names is not changed.
...
# Chunk text with regex token-like offsets while preserving the original text.
...
# This is the ingestion path: it aligns chunk size with the MiniLM tokenizer
# family rather than relying on a rough word/punctuation count.
